...
Use norm() to calculate the finishing time that would distinguish the slowest 25% of men in the men, 31-35 triathlon? Calculate it two ways, once with lower.tail=T and once with lower.tail=F.
