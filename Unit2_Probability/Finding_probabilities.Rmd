...
Q: Do you expect the probability that 3 out of 10 flips will be heads is lower than the probability that 5/10 were heads?  Why?

A: 


8) Next, calculate the probability that 3 out of 10 flips will be heads.  This reflects the probability that this outcome will occur, and is called the density of this distribution at the point where x=5.
